...
function obterIMC(){
  var IMCs = goldSaints.filter(function(e){
    ...
    return (Math.round(((Math.round((e.pesoLb*0.4536)*100)/100)/((e.alturaCm/100)*(e.alturaCm/100)))*100)/100)
  });
  return IMCs;
}
//----------------------08
function obterSobrepeso(){
  var Sobrepeso = goldSaints.filter(function(e){
    ...
    return (Math.round(((Math.round((e.pesoLb*0.4536)*100)/100)/((e.alturaCm/100)*(e.alturaCm/100)))*100)/100) > 25;
  })
  return Sobrepeso;
}