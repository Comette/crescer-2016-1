...
$(function () {
  ...
  function renderizarCavaleiroNaTela(cavaleiro) {
    if(goldSaints.length%2===0){
      $('#div-esquerda .cavaleiros').append( $('<li>').append( $('<img>').attr('src', cavaleiro.imagens[0].url).attr('alt', cavaleiro.nome) ) );
    } else{
      $('#div-direita .cavaleiros').append( $('<li>').append( $('<img>').attr('src', cavaleiro.imagens[0].url).attr('alt', cavaleiro.nome) ) );
    }
  };
